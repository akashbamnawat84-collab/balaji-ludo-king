...
<body>
  ...
  <div id="mainApp" class="hidden">
    ...
    <div class="card hidden" id="joinCard">
      ...
      <p>
        Player 1 से मिला हुआ 8-Digit Room Code डालें।
      </p>
...
async function login() {
  ...
  if (!name) {
    message("loginMessage", "कृपया अपना नाम डालें।");
    return;
  }
  ...
  try {
    ...
    if (!res.ok) {
      message("loginMessage", data.error || "Login failed");
      return;
    }
      ...
      if (
        ...
        if (existing) {
          ...
          return json(
            {
              error:
                "यह Room Code पहले से मौजूद है। दूसरा 8-digit code डालें।"
            },
            409
          );
        }
